# -*- coding: utf-8 -*-
"""Classificação Supervisionada - Recomendação.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1K_w6E-W93eLoQzoIKhTxQM3jT-rGpow-

#Classificação Supervisionada

Esse estudo apresenta um sistema simples de recomendação de filmes basendo-se nos dados das avaliações dos clientes.

**Fonte de Dados:** MovieLens
"""

import pandas as pd

#Dataset com os filmes
filmes = pd.read_csv("movies.csv")
filmes.columns = ["filmeId", "titulo", "generos"]
filmes = filmes.set_index("filmeId")
filmes.head()

#Dataset com as notas dos filmes
...
Esta demonstração efetuada para fins didáticos apresentou o funcionamento de um sistema simples de recomendação de filmes, baseado em algoritmo KNN (vizinhos mais próximos).
"""
